<?php
$conn=mysqli_connect("localhost","root","","morrisjs");
$query="select*from account";
$result=mysqli_query($conn,$query);
$chartdata='';
while($row=mysqli_fetch_array($result)){
    $chartdata .= "{year:'".$row["year"]."',profit:".$row["profit"].",purcase:".$row["purcase"].",sale:".$row["sale"]."}, ";
}
...
<script>
    Morris.Line({
        ...
        xkey:'year',
        ykeys:['profit','purcase','sale'],
        labels:['Laba','Pembelian','Penjualan'],
        hideHower:'auto',
        stacked:true
    })
</script>